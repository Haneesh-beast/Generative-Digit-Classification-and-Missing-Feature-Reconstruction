...
* `images/`: Directory containing generated visualization plots.
  * `gmm_components.png`: Unsupervised GMM components representing digit styles.
  * `classification_predictions.png`: Classification predictions on full MNIST test set.
  * `censored_images.png`: Test set images with central pixels censored.
  * `reconstructed_images.png`: Reconstructed test images using conditional Gaussians.
