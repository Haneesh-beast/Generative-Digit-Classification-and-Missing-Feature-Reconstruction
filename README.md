...
* `notebook/Generative_Digit_Classification.ipynb`: Interactive Jupyter Notebook containing the walk-through of Gaussians, EM algorithms, classifiers, and imputation experiments.
...
jupyter notebook
```
Open the folder `notebook` and run `Generative_Digit_Classification.ipynb` cells sequentially to visualize:
