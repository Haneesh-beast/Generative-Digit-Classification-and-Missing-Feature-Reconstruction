...
![GMM Components](images/1_gmm_components.png)
...
![Classification Predictions](images/2_classification_predictions.png)
...
![Censored Images](images/3_censored_images.png)

And the corresponding reconstructed images generated by using conditional multivariate Gaussians:

![Reconstructed Images](images/4_reconstructed_images.png)
...
* `Generative_Digit_Classification_and_Reconstruction.ipynb`: Interactive Jupyter Notebook containing the walk-through of Gaussians, EM algorithms, classifiers, and imputation experiments.
* `images/`: Directory containing generated visualization plots.
  * `1_gmm_components.png`: Unsupervised GMM components representing digit styles.
  * `2_classification_predictions.png`: Classification predictions on full MNIST test set.
  * `3_censored_images.png`: Test set images with central pixels censored.
  * `4_reconstructed_images.png`: Reconstructed test images using conditional Gaussians.
* `README.md`: Project documentation and mathematical write-up.
...
│   ├── plotData.py
│   └── utils.py
├── Generative_Digit_Classification_and_Reconstruction.ipynb
├── images/
...
jupyter notebook
```
Open `Generative_Digit_Classification_and_Reconstruction.ipynb` and run the cells sequentially to visualize:
