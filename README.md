...
This repository was developed as part of the **CS771 (Introduction to Machine Learning)** course at the **Indian Institute of Technology Kanpur (IITK)** under **Professor Purushottam Kar**.
...
* `generative_digit_classification.ipynb`: Interactive Jupyter Notebook containing the walk-through of Gaussians, EM algorithms, classifiers, and imputation experiments.
...
jupyter notebook
```
Open `generative_digit_classification.ipynb` and run the cells sequentially to visualize:
...
## 🎓 Acknowledgements
This project relies on helper utilities and code structures provided by the teaching staff of CS771 under **Professor Purushottam Kar**, **CSE Department, IIT Kanpur**. The MNIST data loader utility is courtesy of Hojjat Khodabakhsh.
